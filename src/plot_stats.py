...
def plot_learning_curves(filename="./stats.txt"):
    """Построение графиков метрик процесса обучения."""
    ...
    # График средней приспособленности популяции
